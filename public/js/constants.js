...
(function (global) {
    ...
    function isValidActionType(actionType) {
        const validTypes = Object.values(ACTIONS).map(action => typeof action === 'object' ? action.type : action);
    ...
    function validateConstants() {
        ...
        // アクションタイプの重複チェック
        const actionTypes = Object.values(ACTIONS).map(action => typeof action === 'object' ? action.type : action);
