// action-creators.jsの内容を読み込んでエクスポート
export const actionCreatorsScript = `
// アクション作成ヘルパーモジュール
...
(function(global) {
   ...
   */
  function createActionCreators(constants) {
     ...
     */
    function createBaseAction(type, payload = {}) {
      const action = { type };
