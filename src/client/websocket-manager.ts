// This file is auto-generated from src/client/components/websocket-manager.ts. Do not edit manually.
export const websocketManagerScript = `// WebSocket接続管理モジュール
